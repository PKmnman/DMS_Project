...
namespace dms
{
	...
	namespace contact
	{
		...
		{
		public:
			PersonPhoneContact(CSZREF fullname, CSZREF gender, CSZREF phone) : Contact(fullname), PersonContact(gender),
			                                                                   PhoneInfo(phone) { }
		...
		{
		public:
			PersonAddressContact(CSZREF fullname, CSZREF gender, CSZREF street_address, CSZREF district, CSZREF state,
			                     CSZREF zipcode)
			{
				this->name = fullname;
				this->gender = gender;
		...
		{
		public:
			BusinessAddressContact(CSZREF fullname, CSZREF category, CSZREF street_address, CSZREF district,
			                       CSZREF state, CSZREF zipcode)
			{
				this->name = fullname;
				this->category = category;
				this->street_address = street_address;
		...
		using phone_pcontact = PersonPhoneContact;
		using phone_bcontact = BusinessPhoneContact;

		using address_pcontact = PersonAddressContact;
		using address_bcontact = BusinessAddressContact;

		using email_contact = PersonEmailContact;
		using web_contact = BusinessWebContact;
